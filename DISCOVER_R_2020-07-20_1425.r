...
library(Hmisc)
#Read Data
data=read.csv('DISCOVER_DATA_2020-07-20_1425.csv')
#Setting Labels
...
label(data$fu12_inv)="Further investigations or referrals requested?"
...
data$fu12_inv.factor = factor(data$fu12_inv,levels=c("1","2","3","4"))
...
levels(data$fu12_inv.factor)=c("HRCT","Echo","Full lung function","Other")
